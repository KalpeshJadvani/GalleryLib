...
import com.example.kalpesh.gallerylibrary.Adapters.PhotoBucketsAdapter;
...
public class PhotoFragment extends Fragment {
    ...
    public static SubRecyclerViewClass subClass;
    ...
    private void populateRecyclerView() {
        mAdapter = new PhotoBucketsAdapter(bucketNames,bitmapList,getActivity());
        ...
        subClass = new SubRecyclerViewClass(sub_recycler,getActivity(),bucketNames,toolbar);

        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), recyclerView, new ClickListener() {
            @Override
            public void onClick(View view, int position) {
                subClass.setSubRecyclerView(position);
                mAdapter.RandomFunction();
